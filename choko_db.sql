...
--
-- Client :  localhost
-- Généré le :  Mer 15 Janvier 2020 à 09:35
...
INSERT INTO `t_discussion` (`idDiscussion`, `disName`, `idCategory`, `disActive`, `disPrioritized`) VALUES
(1, 'Minecraft', 1, 1, 0);
...
INSERT INTO `t_message` (`idMessage`, `mesText`, `mesDate`, `idDiscussion`, `idUser`) VALUES
...
INSERT INTO `t_user` (`idUser`, `usePseudo`, `useEmail`, `usePassword`, `useBirthDate`, `useSignUpDate`, `useBio`, `useProfilePicture`, `useSignature`, `idGender`, `idGrade`, `idRight`) VALUES
(1, 'Bakbat', 'aviolat.baptiste@gmail.com', 'chokolaaat', '2000-09-26', '2019-11-09', 'Moi c\'est Baptiste, the sniiiiper', 'chokolaaat/resources/images/timestamp.jpg', 'Membre de la team Panda', 1, 1, 1),
(2, 'Qosox', 'matheo0204@hotmail.ch', 'chokolaaat', '2001-04-02', '2019-11-09', 'xxxxxxx', 'chokolaaat/resources/images/timestamp.jpg', 'Membre de Chokolaaat', 1, 1, 1);
...
ALTER TABLE `t_discussion`
  ...
  ADD KEY `t_discussion_t_category_FK` (`idCategory`);
...
ALTER TABLE `t_message`
  ...
  ADD KEY `t_message_t_discussion_FK` (`idDiscussion`),
  ADD KEY `t_message_t_user0_FK` (`idUser`);
...
ALTER TABLE `t_user`
  ...
  ADD KEY `t_user_t_gender_FK` (`idGender`),
  ADD KEY `t_user_t_grade0_FK` (`idGrade`),
  ADD KEY `t_user_t_right1_FK` (`idRight`);
...
--
ALTER TABLE `t_discussion`
  ADD CONSTRAINT `t_discussion_t_category_FK` FOREIGN KEY (`idCategory`) REFERENCES `t_category` (`idCategory`);
...
--
ALTER TABLE `t_message`
  ADD CONSTRAINT `t_message_t_discussion_FK` FOREIGN KEY (`idDiscussion`) REFERENCES `t_discussion` (`idDiscussion`),
  ADD CONSTRAINT `t_message_t_user0_FK` FOREIGN KEY (`idUser`) REFERENCES `t_user` (`idUser`);

--
-- Contraintes pour la table `t_user`
--
ALTER TABLE `t_user`
  ADD CONSTRAINT `t_user_t_gender_FK` FOREIGN KEY (`idGender`) REFERENCES `t_gender` (`idGender`),
  ADD CONSTRAINT `t_user_t_grade0_FK` FOREIGN KEY (`idGrade`) REFERENCES `t_grade` (`idGrade`),
  ADD CONSTRAINT `t_user_t_right1_FK` FOREIGN KEY (`idRight`) REFERENCES `t_right` (`idRight`);
